...
2. All information required is automatically taken from purchase details
3. Customer receives invoice via email to purchase the insurance
4. Electronic insurance certificate is forwarded to the customer via email
...
* [Spain](https://www.simplesurance.co.uk/ecommerce-partner)
...
= 1.0.7 =
Compatibility to wordpress 5.5
...
= 1.0.3 =
Fixed get_customer calls
Added filters 

= 1.0.2 =
Compatibility to wordpress 5.0 and WooCommerce 3.5.2
Fixed variation prices
Fixed variation prices

= 1.0.1 =
Compatibility to wordpress 4.9.1
